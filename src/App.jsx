...
const About = lazy(() => import("./sections/2About"));
const Skills = lazy(() => import("./sections/3Skills"));
const Experience = lazy(() => import("./sections/4Experience"));
const Projects = lazy(() => import("./sections/5Projects"));
const Education = lazy(() => import("./sections/6Education"));
const Certifications = lazy(() => import("./sections/7Certifications"));
const Contact = lazy(() => import("./sections/8Contact"));
const Footer = lazy(() => import("./sections/9Footer"));
