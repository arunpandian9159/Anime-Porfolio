export const profileData = {
  ...
  certifications: [
    ...
    {
      title:
        "India AI Impact Summit Buildathon 2026 (HCL GUVI) Finalist Certification",
      icon: "fas fa-shield-alt",
      image: "/Ai india summit 2026 guvi buildathon 2.webp",
    },
  ],
  achievements: [
    ...
    { text: "NSS Activities - Cycle Rally", icon: "fas fa-bicycle" },
    {
      ...
      icon: "fas fa-trophy",
      image: [
        "/Ai india summit 2026 guvi buildathon 1.webp",
        "/Ai india summit 2026 guvi buildathon 2.webp",
      ],
    },
  ],
  projects: [
    {
      ...
      description: [
        "Recognized as a **Top 2% National Finalist** at the **India AI Impact Buildathon** — out of 40,000+ participants across India.",
        ...
        "Developed a **proactive intelligence extraction engine** featuring **Intel Gap Analysis** to autonomously steer conversations and capture high-value forensic data.",
      ],
    ...
    },
    {
      ...
      featured: true,
      images: ["/tariff extraction 1.webp", "/tariff extraction 2.webp"],
      icon: "fas fa-robot",
      teamSize: 1,
      category: "ai",
    },
    {
      ...
      featured: true,
      isPublished: true,
      images: ["/SRM Conference image.webp", "/certificate-presentation.webp"],
    ...
    },
    {
      ...
      teamSize: 5,
      role: "Frontend Developer",
      images: ["/crm tripxplo 1.webp", "/crm tripxplo 2.webp"],
